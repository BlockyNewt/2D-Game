...
MenuSetting::MenuSetting(sf::RenderWindow* window)
{
	...
	this->t_A_.setSettings("Font/arial.ttf", 50, "Settings", sf::Vector2f(window->getSize().x / 2.f, 10.f), false);

	this->resolution_1280x720_T_A_.setSettings("Font/arial.ttf", 25, "1280 x 720", sf::Vector2f(10.f, 200.f), false);
	...
	this->resolution_600x600_T_A_.setSettings("Font/arial.ttf", 25, "600 x 600", sf::Vector2f(10.f, this->resolution_1280x720_T_A_.getBottomPosition(true, 20.f)), false);
	...
	this->t_B_.setSettings("Font/arial.ttf", 18, "Accept", sf::Vector2f(this->b_B_.getLeftPosition(true, 10.f), this->b_B_.getTopPosition(true, 10.f)), false);

	this->b_C_.setSettings(150.f, 50.f, window->getSize().x / 2.f + 150.f, window->getSize().y - 60.f, sf::Color::Red, 1.f, sf::Color::Red, false);
	this->t_C_.setSettings("Font/arial.ttf", 18, "Close", sf::Vector2f(this->b_C_.getLeftPosition(true, 10.f), this->b_C_.getTopPosition(true, 10.f)), false);
