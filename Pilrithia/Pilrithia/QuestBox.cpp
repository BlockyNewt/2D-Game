...
void QuestBox::setSettings(float posX, float posY, const sf::Color& fillColor, float outlineThickness, const sf::Color& outlineColor)
{
	this->quest_Box_.setSettings(700.f, 400.f, posX - 350.f, posY - 200.f, fillColor, outlineThickness, outlineColor, true);

	this->quest_Text_.setSettings("Font/arial.ttf", 18, "Nothing for now", sf::Vector2f(this->quest_Box_.getLeftPosition(true, 10.f), this->quest_Box_.getTopPosition(true, 10)), true);
